...
const accountTypes = [
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        ...
        <circle cx="20" cy="16" r="8" fill="#EA580C" />
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        ...
        <circle cx="26" cy="18" r="6" fill="#EA580C" />
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
        ...
        <rect x="12" y="12" width="16" height="12" rx="2" fill="#EA580C" />
        ...
        <div className="flex flex-col gap-6">
          {accountTypes.map((t) => (
            <button
              ...
              className="flex items-center gap-4 w-full p-6 rounded-xl border border-[#23262B] bg-[#16181C] hover:border-[#EA580C] transition-colors text-left"
            >
              <div>{t.icon}</div>
              <div>
